...
public class OperationNameSpanNameTest {
    ...
    public void operationNameSpanNameTest() {
        BiFunction<String, ConsumerRecord, String> consumerSpanNameProvider = ClientSpanNameProvider.CONSUMER_OPERATION_NAME;
        BiFunction<String, ProducerRecord, String> producerSpanNameProvider = ClientSpanNameProvider.PRODUCER_OPERATION_NAME;
