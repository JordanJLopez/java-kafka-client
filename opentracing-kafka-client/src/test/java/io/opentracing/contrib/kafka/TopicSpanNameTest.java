...
public class TopicSpanNameTest {
    ...
    public void topicSpanNameTest() {
        ...
        BiFunction<String, ConsumerRecord, String> consumerSpanNameProvider = ClientSpanNameProvider.CONSUMER_TOPIC;
        BiFunction<String, ProducerRecord, String> producerSpanNameProvider = ClientSpanNameProvider.PRODUCER_TOPIC;
